...
### plot.refinedmod
`plot.refinedmod` is applicable to an argument of class $plot.refinedmod$. This will produce an $1\times 3$ panel plots residuals and predicted values for the three models.
