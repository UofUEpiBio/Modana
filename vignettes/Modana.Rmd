...
The package is in development stage and it is only available on [github](https://github.com/Quamena/Modana).
...
```{r}
print(getres$Directmodel)
print(getres$Refinedmodel)
#plot(getres$Refinedmodel)
```
...
res <- refinedmod(formula = response ~ treatment + age + Time + Type,
                    ...
                    trt = "treatment", data = dat,
                     effmod = c("age", "Type"),
                      corstr = "independence")
summary(res$Directmodel)
summary(res$Refinedmodel)
```
